...
export const getBizCard = async (bizCardID: string | undefined) => {
	try {
		let response = await axios.get(`http://localhost:5000/api/getBizCard/${bizCardID}`, {
			headers: {
				Authorization: `Bearer ${sessionStorage.getItem("ent")}`,
			},
		});
...
export const addBizCard = (data: CardType) => {
	try {
		let response = axios.post("http://localhost:5000/api/addBizCard", data, {
			headers: {
				Authorization: `Bearer ${sessionStorage.getItem("ent")}`,
			},
		});
...
export const getUserBizCard = (userID: string | undefined) => {
	try {
		let response = axios.get(`http://localhost:5000/api/getUserBizCard/${userID}`, {
			headers: {
				Authorization: `Bearer ${sessionStorage.getItem("ent")}`,
			},
		});
...
export const deleteBizCard = (cardBizID: string | undefined) => {
	try {
		let response = axios.delete(`http://localhost:5000/api/deleteBizCard/${cardBizID}`, {
			headers: {
				Authorization: `Bearer ${sessionStorage.getItem("ent")}`,
			},
		});
...
export const updateBizCard = (cardBizID: string | undefined, dataToServer: any) => {
	try {
		let response = axios.put(`http://localhost:5000/api/updateBizCard/${cardBizID}`, dataToServer, {
			headers: {
				Authorization: `Bearer ${sessionStorage.getItem("ent")}`,
			},
		});
...
export const updateUser = (userID: string | undefined, dataToServer: any) => {
	try {
		let response = axios.put(`http://localhost:5000/api/updateUser/${userID}`, dataToServer, {
			headers: {
				Authorization: `Bearer ${sessionStorage.getItem("ent")}`,
			},
		});
